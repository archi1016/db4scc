...
Public Declare Function CreateFileMappingW Lib "Kernel32" _
    (ByVal hFile As Long, _
     ByVal lpAttributes As Long, _
     ByVal flProtect As Long, _
     ByVal dwMaximumSizeHigh As Long, _
     ByVal dwMaximumSizeLow As Long, _
     ByVal lpName As Long) As Long

Public Declare Function OpenFileMappingW Lib "Kernel32" _
...
Public Declare Sub GetLocalTime Lib "Kernel32" _
    (ByVal lpSystemTime As Long)
 
Public Declare Function SetLocalTime Lib "Kernel32" _
    (ByVal lpSystemTime As Long) As Long
    
Public Declare Function FileTimeToLocalFileTime Lib "Kernel32" _
    (ByVal lpFileTime As Long, _
     ByVal lpLocalFileTime As Long) As Long
