...
Public Declare Function CompareFileTime Lib "Kernel32" _
    (ByVal lpFileTime1 As Long, _
     ByVal lpFileTime2 As Long) As Long
...
Public Declare Function FindFirstFileExW Lib "Kernel32" _
    (ByVal lpFileName As Long, _
...
Public Const FindExInfoStandard = 0
Public Const FindExInfoBasic = 1
Public Const FindExInfoMaxInfoLevel = 2
     
Public Const FindExSearchNameMatch = 0
Public Const FindExSearchLimitToDirectories = 1
Public Const FindExSearchLimitToDevices = 2
     
Public Const FIND_FIRST_EX_CASE_SENSITIVE = 1
Public Const FIND_FIRST_EX_LARGE_FETCH = 2
